...
DEFAULTS: dict[str, Any] = {
    ...
    "voice": {"provider": "console", "irodori_dir": "", "irodori_reference_audio": ""},
    "vnyan": {"enabled": False, "websocket_url": "ws://127.0.0.1:8000/vnyan"},
    "memory": {"recent_conversation_turns": 8, "recent_events": 12},
    "initiative": {"enabled": True, "idle_check_seconds": 3.0, "min_speech_gap_seconds": 12.0, "boredom_threshold": 0.82, "emotion_threshold": 0.90},
    "mind": {"decay_per_second": 0.0015, "save_interval_seconds": 2.0},
